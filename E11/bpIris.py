...
# Convert the values to numeric ones
...
# = 4. The input depends on how many features we initially feed the model. In our case, there are 4 features for every predict value
...
def test_species():
    ...
    # how many labels of Irises we have. = 3 in our database.
